<template>
  <div class="text-white w-[1152px] px-6 mx-auto">
    ...
    <div class="h-[796px] flex flex-col justify-center items-center">
      <div v-if="isLoading && ideas.length === 0" class="flex flex-col items-center justify-center">
        ...
        <div class="flex justify-between items-center mb-10">
          ...
          >
            ...
            <img src="~/assets/arrow-right.svg" alt="Next" />
                    ...
                    <div ref="cardContainer" class="border border-[#00D37E] rounded-[6px] p-16 h-[666px] overflow-y-auto relative">
                      ...
                      <div v-if="currentIdea">
                        ...
                        <div class="flex justify-between items-start mb-4">
                          ...
                          <div>
                            ...
                            <div ref="ideaLabelWrapper" class="border border-[#00D37E] rounded-md px-2 py-1 inline-block mb-4 overflow-hidden">

                              <p class="text-[#00FF98] font-bold text-[18px] leading-[1.44]">IDEA {{ currentIndex + 1 }} OF {{ ideas.length }}</p>

                            </div>

                            <div ref="cardTitleWrapper" class="overflow-hidden">

                              <h2 class="text-[62px] font-semibold leading-[1.19] mb-4">{{ currentIdea.title }}</h2>
                        ...
                        <div ref="cardDescriptionWrapper" class="overflow-hidden">
                          ...
                          <p class="text-[22px] leading-[1.5] mb-12">
                            ...
                            {{ currentIdea.description }}
                                  ...
                                  <div class="p-12 rounded-lg flex flex-col items-center gap-[17px] relative overflow-hidden">
                                                                            ...
                                                                            <div ref="marqueeContainer" class="absolute inset-0">
                                                                                              ...
                                                                                              <img src="~/assets/group1.svg" alt="decoration" class="absolute w-full left-1/2 -translate-x-1/2 top-[38px]" />

              

                                                                                              <img src="~/assets/group2.svg" alt="decoration" class="absolute w-full left-1/2 -translate-x-1/2 top-[138px]" />

              

                                                                                              <img src="~/assets/group3.svg" alt="decoration" class="absolute w-full left-1/2 -translate-x-1/2 top-[238px]" />

              

                                                                                              <img src="~/assets/group1.svg" alt="decoration" class="absolute w-full left-1/2 -translate-x-1/2 top-[338px]" />

              

                                                                                              <img src="~/assets/group2.svg" alt="decoration" class="absolute w-full left-1/2 -translate-x-1/2 top-[438px]" />

              

                                                                                              <img src="~/assets/group3.svg" alt="decoration" class="absolute w-full left-1/2 -translate-x-1/2 top-[538px]" />
                                    ...
                                    <div ref="generateGuideBtnWrapper" class="overflow-hidden z-10">
                                      ...
                                      <button class="flex items-center justify-center gap-[10px] bg-white text-[#009358] px-[24px] py-[17px] rounded-[4px] font-semibold text-[22px] h-[74px]">
...
watch(currentIdea, (newValue, oldValue) => {
  if (newValue && !oldValue) { // Initial load of an idea
    nextTick(() => {
      animateCardIn('next'); // Treat initial load as coming from 'next' direction
      startMarqueeAnimation(); // Start marquee animation here
    });
  }
}, { deep: true }); // Deep watch for changes within the idea object if needed
