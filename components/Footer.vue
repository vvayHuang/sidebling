<template>
  <footer class="relative w-full overflow-hidden h-[837px] md:h-[845px] flex flex-col justify-between p-4 md:p-12">
    <!-- Background Image -->
    ...
    <!-- Bottom Bar -->
    <div
      class="relative z-10 flex flex-col-reverse md:flex-row justify-between md:items-center text-light-inverse-on-surface text-base font-medium tracking-wide uppercase gap-8 md:gap-0 mb-4 md:mb-0">
