<template>
  <div class="relative w-full overflow-hidden flex flex-col justify-between px-4 py-8 md:px-8 md:py-12">
    <!-- Background Image -->
    <img
      :src="backgroundImage"
    ...
    <!-- Bottom Bar -->
    <div class="relative z-10 flex flex-col-reverse md:flex-row justify-between md:items-center text-light-inverse-on-surface text-base font-medium tracking-wide uppercase gap-8 md:gap-0">
