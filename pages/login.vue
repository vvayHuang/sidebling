<template>
  <div class="min-h-screen w-full flex relative lg:static">
    ...
    <div class="absolute top-6 left-6 z-20 lg:hidden">
      <NuxtLink to="/">
        <img src="/logo_horizontal.svg" alt="Stratum Logo" class="h-8 brightness-0 invert" />
      </NuxtLink>
    </div>
    ...
    <div
      class="absolute inset-0 z-10 flex items-center justify-center p-6 lg:static lg:w-1/2 lg:order-1 lg:bg-light-surface-container-high lg:p-12">
      ...
      <div
        class="bg-light-surface-container-high p-6 rounded-xl shadow-xl w-full flex flex-col items-center lg:shadow-none lg:rounded-none lg:items-start lg:text-left lg:bg-transparent lg:p-0 lg:h-full lg:justify-between lg:mx-auto">
